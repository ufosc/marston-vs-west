...
var playState = {
    ...
    create: function () {
        ...
        if (Player1.controlnum === -1) {
            ...
            Player1.controller1.buttonleft.scale.x = 2;
            Player1.controller1.buttonleft.scale.y = 2;
            Player1.controller1.buttonleft.position.x = 0;
            Player1.controller1.buttonleft.position.y = game.world.height*0.8;
            ...
            Player1.controller1.buttonright.scale.x = 2;
            Player1.controller1.buttonright.scale.y = 2;
            Player1.controller1.buttonright.position.x = (2 * Player1.controller1.buttonleft.width);
            Player1.controller1.buttonright.position.y = game.world.height*0.8;
            ...
            Player1.controller1.buttonup.scale.x = 2;
            Player1.controller1.buttonup.scale.y = 2;
            Player1.controller1.buttonup.position.x = Player1.controller1.buttonleft.width;
            Player1.controller1.buttonup.position.y = game.world.height*0.8 - Player1.controller1.buttonleft.height;
            ...
            Player1.controller1.buttondown.scale.x = 2;
            Player1.controller1.buttondown.scale.y = 2;
            Player1.controller1.buttondown.position.x = Player1.controller1.buttonleft.width;
            Player1.controller1.buttondown.position.y = game.world.height*0.8 + Player1.controller1.buttonleft.height;
            ...
            Player1.controller1.buttona.scale.x = 2;
            Player1.controller1.buttona.scale.y = 2;
            Player1.controller1.buttona.position.x = game.world.width - (Player1.controller1.buttonleft.width);
            Player1.controller1.buttona.position.y = game.world.height*0.8;
            ...
            Player1.controller1.buttonb.scale.x = 2;
            Player1.controller1.buttonb.scale.y = 2;
            Player1.controller1.buttonb.position.x = game.world.width - (2 * Player1.controller1.buttonleft.width);
            Player1.controller1.buttonb.position.y = game.world.height*0.8 + Player1.controller1.buttonleft.height;
            ...
            Player1.controller1.buttonx.scale.x = 2;
            Player1.controller1.buttonx.scale.y = 2;
            Player1.controller1.buttonx.position.x = game.world.width - (2 * Player1.controller1.buttonleft.width);
            Player1.controller1.buttonx.position.y = game.world.height*0.8 - Player1.controller1.buttonleft.height;
            ...
            Player1.controller1.buttony.scale.x = 2;
            Player1.controller1.buttony.scale.y = 2;
            Player1.controller1.buttony.position.x = game.world.width - (3 * Player1.controller1.buttonleft.width);
            Player1.controller1.buttony.position.y = game.world.height*0.8;
    ...
    */
    ...
    itemUpdate: function (helditem, targetFighter) {
        ...
        //If close to item, and if he isnt holding something, grab it!
