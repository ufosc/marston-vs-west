var creditsState = {
    create: function () {
        ...
        var textLabel = game.add.text(game.world.width * .75, game.world.height * 0.83, 'Music:\nBryan Alvarez', { font: '50px Permanent Marker', fill: '#ffffff' });
        ...
        var menuLabel = new TextButton(this.game, game.world.width * .1, game.world.height * .15, 'MENU', { font: '90px Permanent Marker', fill: '#ffffff' });
