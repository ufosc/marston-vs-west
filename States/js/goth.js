class goth extends Fighter {
    constructor(character, health, lives, startx, starty, controlnum) {
        ...
        this.aniRight = this.character.animations.add('right', [3, 4, 5, 6, 7, 8, 9, 10, 11], 10, true);
        this.aniRight.onComplete.add(this.walkEnd, this);

        //idle animation
        this.aniIdle = this.character.animations.add('idle', [3, 4], 5, true);
        ...
        //punch animations
        this.aniPunchWindUp= this.character.animations.add('punchwindup', [20, 20, 20], 5, false);
        this.aniPunchWindUp.onStart.add(this.PunchWindUpStart, this);
        this.aniPunchWindUp.onComplete.add(this.PunchWindUpEnd, this);

        this.aniPunch = this.character.animations.add('punch', [20, 21, 22], 10, false);
        ...
        this.aniJumpKick = this.character.animations.add('jumpKick', [14, 13, 12, 12, 12], 5, false);
        ...
        this.aniUppercutWindUp= this.character.animations.add('Uppercutwindup', [14, 15, 16, 16, 16], 5, false);
        ...
        this.aniKo = this.character.animations.add('ko', [23], 5, false);
